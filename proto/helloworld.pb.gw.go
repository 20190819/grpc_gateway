...
func request_YourService_DownloadFile_0(ctx context.Context, marshaler runtime.Marshaler, client YourServiceClient, req *http.Request, pathParams map[string]string) (YourService_DownloadFileClient, runtime.ServerMetadata, error) {
	var protoReq HRequest
	var metadata runtime.ServerMetadata
...
func RegisterYourServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server YourServiceServer) error {
	...
	mux.Handle("POST", pattern_YourService_DownloadFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterYourServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client YourServiceClient) error {
	...
	mux.Handle("POST", pattern_YourService_DownloadFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_YourService_DownloadFile_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_YourService_DownloadFile_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_YourService_Echo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "helloworld", "echo"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_YourService_DownloadFile_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "helloworld", "getfile"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_YourService_Echo_0 = runtime.ForwardResponseMessage

	forward_YourService_DownloadFile_0 = runtime.ForwardResponseStream
)
